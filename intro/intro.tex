...
\item 
  \Autoref{ch:dtcwt_scat} proposes a change to the core of the ScatterNet. In
  ...
  30 times speed up.
\item 
  \Autoref{ch:visualizing} describes our \emph{DeScatterNet}, a tool used to
...
\item 
  \Autoref{ch:invariant} describes the \emph{Learnable ScatterNet} we have developed to 
