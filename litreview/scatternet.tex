...
\end{equation}
We can make $W$ non-expansive with appropriate scaling. Define the energy $\energy{Wx}$ as
\begin{equation}
...
\end{equation}
We have already shown that $S$ is the repeated application of $\tilde{W}$ in
