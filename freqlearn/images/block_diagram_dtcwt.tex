\begin{tikzpicture}[%
  ...
  \foreach \i in {1,...,5} {
    ...
    \draw [->, fill=gray!30,ultra thick] (13.8+0.1*\i, -1.5, -7+2.5*\i) -- (14.8+0.1*\i, -1.5, -7+2.5*\i)
      node[midway, above] {$\sigma_{bp}$};
  ...
  \draw [->, fill=gray!30,ultra thick] (9.8+6*0.08, -1.5, 8) -- (10.8+6*0.08, -1.5, 8);
    % node[midway, above] {$\sigma_w$};
  \draw [->, fill=gray!30,ultra thick] (13.8+6*0.1, -1.5, 8) -- (14.8+6*0.1, -1.5, 8)
    node[midway, above] {$\sigma_{bp}$};
  \tikzcuboid{
  shiftx=8.5cm,
  shifty=-1.0cm,
