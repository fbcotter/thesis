\begin{table}[ht]
  ...
  kernels as a base.  $C$ is a hyperparameter that controls the network width,
  we use $C=64$ for our tests.}
  ...
  \makebox[\textwidth]{
    \begin{tabular}{l l l l}
      ...
      \begin{tabular}{@{}l@{}}
        ...
        \\ \\
        gain2, $g_{lp} \in \reals[2C\x C\x 5\x 5],\ g_1 \in \complexes[2C \x 6\x C\x 1\x 1]$ \\ %, $\F{stride} = 2$\\       
        \\ \\
        gain3, $g_{lp} \in \reals[4C\x 2C\x 5\x 5],\ g_1 \in \complexes[4C \x 6\x 2C\x 1\x 1]$\\ % , $\F{stride} = 2$\\       
        \\ \\
        \\
      \end{tabular}\\
      \bottomrule
