...
b_r - a_i \conv b_i) + j(a_r \conv b_i + a_i \conv b_r)$ (see \autoref{app:ch6:complex_backprop}). 
...
convolved with the time reverse of the filter (proved in \autoref{ch:litreview}).
...
See \autoref{app:ch6:soft_shrink} for derivations of the
...
\begin{table}[t]
  ...
  \begin{tabular}{l |p{\mywidth} p{\mywidth} p{\mywidth} p{\mywidth} p{\mywidth} }
      ...
      \hline
      None & 45.0 & 63.1 & 64.4 & 61.4 & 42.5 \\
      ReLU & 42.6 & 62.4 & 63.9 & 60.7 & 41.8\\
      BN+MagReLU & 48.5 & 65.0 & 62.6 & X & X\\
      $\mathcal{S}$ & X & X & X & 61.5 & X \\
