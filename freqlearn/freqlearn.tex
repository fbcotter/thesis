...
%    \newline
  ...
  \caption[Contour Plots]{\subref{fig:dtcwt_bands_freq} Contour plots at -1dB and -3dB showing the support in the
    ...
    % $g_2 \complexes[64\x 1 \x 6\x 1\x 1] $.}
    % and $g_2[f,c,l,h,w] \sim \mathcal{N}(0,1)$ randomly initialized $g_1, g_l$ set to 0.}
...
\begin{figure}[ht]
  ...
  % \makebox[\textwidth][c]{%
    % \resizebox{1.1\textwidth}{!}{\input{gain_layer}}
  % }
  \caption[Contour Plots]{\subref{fig:fwd_pass} Forward and \subref{fig:bwd_pass} backward pass of our system, based on Figure~4 in
...
% \begin{tabular}{cc|cccccc|}
  ...
  % \hline
  % \multicolumn{1}{|l|}{\multirow{2}{*}{CIFAR-10}} 
  % & LeNet & 46.4 & 51.3 & 59.75 & \textbf{66.9} & 71.2  & \textbf{74.0} \\ \cline{2-8}
  % \multicolumn{1}{|l|}{}  & WaveLeNet & \textbf{47.7} & \textbf{53.7}  & \textbf{60.75} & 66.6
                          % & 71.2 & 73.23\\ \hline
  % \multicolumn{1}{|l|}{\multirow{2}{*}{CIFAR-100}} 
  % & LeNet & 9.6 & 13.4 & 19.16 & 25.8 & 33.3 & 42.3  \\ \cline{2-8}
  % \multicolumn{1}{|l|}{}   & WaveLeNet & 11.0 & 16.5 & 21.9 & 27.7  & 33.9 & 40.0 \\ \hline
% \end{tabular}
