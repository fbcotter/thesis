\section{Related Work}
  ...
  \begin{figure}
    \centering
      ...
      \mycaption{Deconvolution Network Block Diagram}{Note the switches that
  ...
  In \cite{springenberg_striving_2014-3}, the authors design an \emph{all convolutional} model,
