...
\begin{figure}[t]
  ...
  \mycaption{The Descattering Network}{Comprises a DeScattering layer (left)
...
examining and all values in the other channels.
...
$S_1$ coefficients, we randomly choose 3 orientations from $S_1^1$ and 3 $S_1^2$.
